/*! * Webflow: Front-end site library * @license MIT * Inline scripts may access the api using an async handler: * var Webflow = Webflow || []; * Webflow.push(readyFunction); */ ! function(t) {
  ...
  i.resize = O(u, k), i.scroll = O(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = O(), i.location = function(t) {
    ...
    t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (d = t.domready), f.each(r, m), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === _.state() && z()
  ...
  window.tram = function(t) {
    ...
    var D = e.frame = function() {
      ...
      U = l(function(e) {
        function n() {
          ...
          if (r)
            for (D(n), e = F(), t = r; t--;)(i = u[t]) && i.render(e)
        }
        var i = {
          ease: f.ease[1],
          from: 0,
        ...
        e.init = function(t) {
          ...
          var t;
          this.active || (this.start || (this.start = F()), this.active = !0, t = this, 1 === u.push(t) && D(n))
        }, e.stop = function() {
          var e, n, i;
    ...
    j.transform && (Z.transform = [I], Q = {
      ...
      skewX: [_],
      skewY: [_]
    }), j.transform && j.backface && (Q.z = [x, "translateZ"], Q.rotateZ = [_], Q.scaleZ = [w], Q.perspective = [y]);
    var J = /ms/,
      V = /s|\./;
    return t.tram = e
  }(window.jQuery)
  ...
  i.define("forms", t.exports = function(t, e) {
    ...
    function b(e, n) {
        ...
        ! function(e, n) {
          ...
          if (m) l.on("click", function(t) {
            ...
            v.on("click", function() {
              ...
              (i = r.target && r.target.files && r.target.files[0]) && (o.toggle(!1), c.toggle(!1), a.toggle(!0), g.text(i.name), S() || x(n), n.fileUploads[e].uploading = !0, function(e, n) {
                var i = {
                  name: e.name,
                  size: e.size
                };
          ...
          function O(t) {
            var i = t.responseJSON && t.responseJSON.msg,
              r = _;
            "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = b : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = w), d.text(r), l.removeAttr("data-value"), l.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), n.fileUploads[e].uploading = !1, S() || y(n)
          }
      ...
      o.handler = null, o.redirect = i.attr("data-redirect"), g.test(u) ? o.handler = O : u || (r ? o.handler = "function" == typeof hostedSubmitWebflow ? hostedSubmitWebflow : k : w())
    }
    ...
    return u.ready = u.design = u.preview = function() {
      ! function() {
        ...
        o = !0, c.on("submit", h + " form", function(e) {
          var n = t.data(this, h);
          n.handler && (n.evt = e, n.handler(n))
        });
        c.on("change", h + ' form input[type="checkbox"]:not(.w-checkbox-input)', function(e) {
    ...
    function _(n, r) {
      ...
      u || (u = t.data(r, p, {
        ...
        return function(n, i) {
          i = i || {};
          var r = l.width();
          E(t), !0 === i.open && M(t, !0), !1 === i.open && q(t, !0), t.open && e.defer(function() {
            r !== l.width() && z(t)
          })
        }
      }(u))) : (! function(e) {
    ...
    function M(t, e) {
      if (!t.open) {
        ...
        if (T(0, l), w.intro(0, l), i.redraw.up(), a || f.on("tap" + p, t.outside), !e) {
          ...
          if (t.overlay && (b = t.menu.prev(), t.overlay.show().append(t.menu)), n.animOver) return c(t.menu).add(h).set({
            x: n.animDirect * s,
            height: r
          }).start({
            x: 0
